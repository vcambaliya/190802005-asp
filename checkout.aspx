<%@ Page Title="" Language="C#" MasterPageFile="~/ClientMasterPage.master" AutoEventWireup="true" CodeFile="checkout.aspx.cs" Inherits="_Default" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    <div class="payment-icon">
                                        <ul>
                                            <li><img class="img-fluid" src="client_src/images/payment-icon/1.png" alt=""></li>
                                            <li><img class="img-fluid" src="client_src/images/payment-icon/2.png" alt=""></li>
                                            <li><img class="img-fluid" src="client_src/images/payment-icon/3.png" alt=""></li>
                                            <li><img class="img-fluid" src="client_src/images/payment-icon/5.png" alt=""></li>
                                            <li><img class="img-fluid" src="client_src/images/payment-icon/7.png" alt=""></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
